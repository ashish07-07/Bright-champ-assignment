...
//               <Link href={`/Takequiz?id=${quiz.id}`}>
//                 <button
//                   className="mt-4 px-4 py-2 bg-gradient-to-r from-green-400 to-green-600 text-white rounded-lg hover:from-green-500 hover:to-green-700 transition duration-300"
//                   onClick={async function () {
//                     const res = await axios.post("/api/Seeparticularquiz", {
//                       id: quiz.id,
//                       name: quiz.name,
//                     });
//                     console.log(res);
